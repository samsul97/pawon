...
if (isset($_POST['nama']) && isset($_POST['email']) && isset($_POST['notlp'])&& isset($_POST['alamat'])&& isset($_POST['password'])) {
    ...
    if ($db->isUserExisted($email)) {
        ...
        // buat user baru
        $user = $db->simpanUser($nama, $email,$notlp,$alamat, $password);
        if ($user) {
            ...
            $response["user"]["email"] = $user["email"];
                        $response["user"]["notlp"] = $user["notlp"];
